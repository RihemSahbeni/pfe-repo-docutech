...
const ProjectTableforuser = () => {
  ...
  const handleAddusertoProject = async (id) => {
    await AddusertoProject(id, {
      PUsers: selectedUsers,
    });
    setSelectedUsers([]);
    getProjectDetails(id);
  };
  //open and close modal Add user to project
  ...
  const isAleadyIn = (id) => {
    return PUsers.findIndex((p) => p.id === id) !== -1; // -1 => false / != -1 true
  };
  useEffect(() => {
    getData();
  }, []);
      ...
      <div>
        <nav>
          <ol className="breadcrumb">
            ...
            <li className="breadcrumb-item">Projet</li>
            <li className="breadcrumb-item active">Liste</li>
          </ol>
          <div className="pagetitle">
            <h1 className="text-center pagetitle">Mes projets</h1>
  ...
  } else if (currentItemsp.length === 0) {
    return (
      <div>
        <nav>
          <ol className="breadcrumb">
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <form className="row g-3">
                        ...
                        <div className="col-md-6 label text-dark">
                          <i className="bi bi-calendar2-date" /> Date de
                          création
                        </div>
                        <div className="col-md-6">
                          {projectDetails && projectDetails.CreationDate && (
                            <p>
                              {new Date(
                          ...
                          <div class="row">
                            <div class="col mb-0">
                              <label for="dobWithTitle" class="form-label">
                                {" "}
                                <i class="bi bi-calendar4-week text-primary ">
                                  {" "}
                                </i>
                                Date debut
                              </label>
          ...
          >
            ...
            <Modal.Footer>
              ...
              <button
                ...
                onClick={() => handleAddusertoProject(projectDetails.id)}
              >
                Sauvgarder
              </button>
            </Modal.Footer>
...
export default ProjectTableforuser;
